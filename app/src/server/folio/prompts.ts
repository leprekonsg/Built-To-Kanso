...
export const OPENAI_IMAGE_PROMPTS: Record<ImagePromptKind, OpenAIImagePromptSpec> = {
  ...
  "environmental-texture-atlas": {
    ...
    prompt: [
      ...
      "Tile 2: fine rice-paper grain, Bone White #F6F3EE, subtle fiber direction, low contrast.",
      "Tile 3: sunlit dust motes in a warm HDB interior light field, sparse West Sun Amber #E7A63D and off-white particles, no outer-space blackness, no bokeh circles larger than dust.",
