...
export const OPENAI_IMAGE_PROMPTS: Record<ImagePromptKind, OpenAIImagePromptSpec> = {
  ...
  "life-sketch-from-anchor": {
    ...
    prompt: [
      ...
      "Task: Materialize a locked Three.js room anchor into a photorealistic Singapore HDB interior without changing the anchor.",
      "Source of truth: Image 1 is LOCKED 3D ANCHOR showing camera, room proportions, openings, walls, doors, balcony, kitchen doorway, and token positions. Optional later images are mood and material references only.",
      "Authority order: Image 1 geometry and camera override style references, photorealism, interior-design convention, and aesthetic cleanup.",
      "Change only: materials, surface finish, realistic lighting, shadow softness, exposure, fine sensor grain, and quiet HDB atmosphere.",
      "Preserve exactly: camera angle, crop, room proportions, ceiling height, wall edges, door positions, window positions, balcony direction, kitchen doorway, Household Shelter door if visible, major object positions, and token placement from Image 1.",
      "Scene/backdrop: honest compact Singapore HDB architecture, light oak floor, off-white limewash walls, sheer linen curtains, HDB balcony light, modest public-housing proportions.",
      "Objects: preserve major object and token positions from the anchor. Use a plain wooden-bladed ceiling fan only if visible in Image 1.",
      "Lighting/mood: Singapore late-afternoon equatorial sun, warm 4500K, soft balcony light, long gentle shadow bars, realistic exposure, calm Monsoon Atelier atmosphere.",
      "Reject output if: extra rooms appear, openings shift, walls move, balcony direction changes, tokens move, luxury-condo cues appear, visible text appears, or the scene reads as generic render-SaaS staging.",
      "Constraints: no extra rooms, no luxury condo cues, no marble lobby, no track lighting unless present in Image 1, no cove lighting, no designer pendant lighting, no tatami, no torii, no Kyoto temple, no cherry blossoms, no Mt Fuji, no fireplace, no Nordic snow, no visible text, no logos, no people, no watermark.",
    ].join("\n"),
  },
